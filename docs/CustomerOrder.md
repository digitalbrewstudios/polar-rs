...
**user_id** | **String** |  | 
**product** | Option<[**models::CustomerOrderProduct**](CustomerOrderProduct.md)> |  | 
**subscription** | Option<[**models::CustomerOrderSubscription**](CustomerOrderSubscription.md)> |  | 
...
**next_payment_attempt_at** | Option<**String**> |  | [optional]
