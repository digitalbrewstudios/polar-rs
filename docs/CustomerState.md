...
**active_subscriptions** | [**Vec<models::CustomerStateSubscription>**](CustomerStateSubscription.md) | The customer's active subscriptions. | 
**granted_benefits** | [**Vec<models::CustomerStateBenefitGrant>**](CustomerStateBenefitGrant.md) | The customer's active benefit grants. | 
**active_meters** | [**Vec<models::CustomerStateMeter>**](CustomerStateMeter.md) | The customer's active meters. | 
