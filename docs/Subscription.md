...
**customer** | [**models::SubscriptionCustomer**](SubscriptionCustomer.md) |  | 
**product** | [**models::Product**](Product.md) |  | 
**discount** | Option<[**models::SubscriptionDiscount**](SubscriptionDiscount.md)> |  | 
...
**meters** | [**Vec<models::SubscriptionMeter>**](SubscriptionMeter.md) | List of meters associated with the subscription. | 
