...
**prices** | [**Vec<models::CheckoutLinkProductPricesInner>**](CheckoutLinkProduct_prices_inner.md) | List of available prices for this product. | 
**benefits** | [**Vec<models::BenefitPublic>**](BenefitPublic.md) | The benefits granted by the product. | 
**medias** | [**Vec<models::ProductMediaFileRead>**](ProductMediaFileRead.md) | The medias associated to the product. | 
