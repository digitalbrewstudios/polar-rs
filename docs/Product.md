...
**benefits** | [**Vec<models::Benefit>**](Benefit.md) | List of benefits granted by the product. | 
**medias** | [**Vec<models::ProductMediaFileRead>**](ProductMediaFileRead.md) | List of medias associated to the product. | 
**attached_custom_fields** | [**Vec<models::AttachedCustomField>**](AttachedCustomField.md) | List of custom fields attached to the product. | 
