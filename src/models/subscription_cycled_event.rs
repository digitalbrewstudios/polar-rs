...
pub struct SubscriptionCycledEvent {
    ...
    pub metadata: Box<models::SubscriptionCycledMetadata>,
}

impl SubscriptionCycledEvent {
    ...
    pub fn new(
        ...
        source: Source,
        name: Name,
        metadata: models::SubscriptionCycledMetadata,
