...
pub struct CustomFieldUpdateSelect {
    ...
    pub properties: Option<Option<Box<models::CustomFieldSelectProperties>>>,
}

impl CustomFieldUpdateSelect {
    /// Schema to update a custom field of type select.
    pub fn new(r#type: Type) -> CustomFieldUpdateSelect {
