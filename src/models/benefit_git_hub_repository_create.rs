...
pub struct BenefitGitHubRepositoryCreate {
    ...
    pub properties: Box<models::BenefitGitHubRepositoryCreateProperties>,
}

impl BenefitGitHubRepositoryCreate {
    pub fn new(
        r#type: Type,
        description: String,
        properties: models::BenefitGitHubRepositoryCreateProperties,
