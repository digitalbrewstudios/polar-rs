...
pub struct BenefitCustomSubscriber {
    ...
    pub properties: Box<models::BenefitCustomSubscriberProperties>,
}

impl BenefitCustomSubscriber {
    pub fn new(
        id: String,
        created_at: String,
        ...
        properties: models::BenefitCustomSubscriberProperties,
