...
pub struct BenefitLicenseKeysUpdate {
    ...
    pub properties: Option<Option<Box<models::BenefitLicenseKeysCreateProperties>>>,
}

impl BenefitLicenseKeysUpdate {
    pub fn new(r#type: Type) -> BenefitLicenseKeysUpdate {
