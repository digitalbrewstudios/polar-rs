...
pub struct Checkout {
    ...
    #[serde(rename = "customer_metadata")]
    pub customer_metadata: std::collections::HashMap<String, models::CustomerMetadataValue>,
}
...
impl Checkout {
    ...
    pub fn new(
        ...
        customer_metadata: std::collections::HashMap<String, models::CustomerMetadataValue>,
    ) -> Checkout {
        Checkout {
            id,
            created_at,
