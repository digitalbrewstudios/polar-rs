...
pub struct BenefitLicenseKeysCreate {
    ...
    pub properties: Box<models::BenefitLicenseKeysCreateProperties>,
}

impl BenefitLicenseKeysCreate {
    pub fn new(
        r#type: Type,
        description: String,
        properties: models::BenefitLicenseKeysCreateProperties,
