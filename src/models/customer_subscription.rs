...
pub struct CustomerSubscription {
    ...
    pub product: Box<models::CustomerSubscriptionProduct>,
    ...
    #[serde(rename = "meters")]
    pub meters: Vec<models::CustomerSubscriptionMeter>,
    /// Whether the subscription is managed by Polar.
    #[serde(rename = "is_polar_managed")]
    pub is_polar_managed: bool,
}
...
impl CustomerSubscription {
    pub fn new(
        ...
        meters: Vec<models::CustomerSubscriptionMeter>,
