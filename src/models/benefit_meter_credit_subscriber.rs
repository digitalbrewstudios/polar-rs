...
pub struct BenefitMeterCreditSubscriber {
    ...
    pub properties: Box<models::BenefitMeterCreditSubscriberProperties>,
}

impl BenefitMeterCreditSubscriber {
    pub fn new(
        id: String,
        created_at: String,
        ...
        properties: models::BenefitMeterCreditSubscriberProperties,
