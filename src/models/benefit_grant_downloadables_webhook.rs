...
pub struct BenefitGrantDownloadablesWebhook {
    ...
    pub benefit: Box<models::BenefitDownloadables>,
    ...
    pub previous_properties: Option<Option<Box<models::BenefitGrantDownloadablesProperties>>>,
}

impl BenefitGrantDownloadablesWebhook {
    pub fn new(
        created_at: String,
        ...
        benefit: models::BenefitDownloadables,
