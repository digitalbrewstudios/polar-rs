...
pub struct BenefitCustomUpdate {
    ...
    pub properties: Option<Option<Box<models::BenefitCustomProperties>>>,
}

impl BenefitCustomUpdate {
    pub fn new(r#type: Type) -> BenefitCustomUpdate {
        BenefitCustomUpdate {
            metadata: None,
            description: None,
            r#type,
