...
pub struct CustomFieldUpdateCheckbox {
    ...
    pub properties: Option<Option<Box<models::CustomFieldCheckboxProperties>>>,
}

impl CustomFieldUpdateCheckbox {
    /// Schema to update a custom field of type checkbox.
    pub fn new(r#type: Type) -> CustomFieldUpdateCheckbox {
