...
pub struct BenefitGitHubRepository {
    ...
    pub properties: Box<models::BenefitGitHubRepositoryProperties>,
}

impl BenefitGitHubRepository {
    ...
    pub fn new(
        ...
        properties: models::BenefitGitHubRepositoryProperties,
