...
pub struct CustomerBenefitGrantDiscord {
    ...
    pub benefit: Box<models::BenefitDiscordSubscriber>,
    #[serde(rename = "properties")]
    pub properties: Box<models::BenefitGrantDiscordProperties>,
}

impl CustomerBenefitGrantDiscord {
    pub fn new(
        created_at: String,
        ...
        benefit: models::BenefitDiscordSubscriber,
