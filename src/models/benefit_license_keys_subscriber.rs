...
pub struct BenefitLicenseKeysSubscriber {
    ...
    pub properties: Box<models::BenefitLicenseKeysSubscriberProperties>,
}

impl BenefitLicenseKeysSubscriber {
    pub fn new(
        id: String,
        created_at: String,
        ...
        properties: models::BenefitLicenseKeysSubscriberProperties,
