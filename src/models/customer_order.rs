...
pub struct CustomerOrder {
    ...
    pub product: Option<Box<models::CustomerOrderProduct>>,
    #[serde(rename = "subscription", deserialize_with = "Option::deserialize")]
    pub subscription: Option<Box<models::CustomerOrderSubscription>>,
    ...
    #[serde(
        rename = "next_payment_attempt_at",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub next_payment_attempt_at: Option<Option<String>>,
}
...
impl CustomerOrder {
    pub fn new(
        ...
        user_id: String,
        product: Option<models::CustomerOrderProduct>,
        subscription: Option<models::CustomerOrderSubscription>,
