...
pub struct BenefitGitHubRepositoryUpdate {
    ...
    pub properties: Option<Option<Box<models::BenefitGitHubRepositoryCreateProperties>>>,
}

impl BenefitGitHubRepositoryUpdate {
    pub fn new(r#type: Type) -> BenefitGitHubRepositoryUpdate {
