...
pub struct BenefitDiscordUpdate {
    ...
    pub properties: Option<Option<Box<models::BenefitDiscordCreateProperties>>>,
}

impl BenefitDiscordUpdate {
    pub fn new(r#type: Type) -> BenefitDiscordUpdate {
