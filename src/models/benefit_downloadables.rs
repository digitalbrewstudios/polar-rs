...
pub struct BenefitDownloadables {
    ...
    pub properties: Box<models::BenefitDownloadablesProperties>,
}

impl BenefitDownloadables {
    pub fn new(
        id: String,
        created_at: String,
        ...
        properties: models::BenefitDownloadablesProperties,
