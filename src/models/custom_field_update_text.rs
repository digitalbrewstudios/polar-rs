...
pub struct CustomFieldUpdateText {
    ...
    pub properties: Option<Option<Box<models::CustomFieldTextProperties>>>,
}

impl CustomFieldUpdateText {
    /// Schema to update a custom field of type text.
    pub fn new(r#type: Type) -> CustomFieldUpdateText {
