...
pub struct DiscountFixedRepeatDurationCreate {
...
impl DiscountFixedRepeatDurationCreate {
    /// Schema to create a fixed amount discount that is applied on every invoice for a certain number of months.
    pub fn new(
