...
pub struct CustomFieldCreateNumber {
    ...
    pub properties: Box<models::CustomFieldNumberProperties>,
}

impl CustomFieldCreateNumber {
    /// Schema to create a custom field of type number.
    pub fn new(
        r#type: Type,
        slug: String,
        name: String,
        properties: models::CustomFieldNumberProperties,
