...
pub struct BenefitGrantLicenseKeysWebhook {
    ...
    pub benefit: Box<models::BenefitLicenseKeys>,
    ...
    pub previous_properties: Option<Option<Box<models::BenefitGrantLicenseKeysProperties>>>,
}

impl BenefitGrantLicenseKeysWebhook {
    pub fn new(
        created_at: String,
        ...
        benefit: models::BenefitLicenseKeys,
