...
pub struct BenefitLicenseKeys {
    ...
    pub properties: Box<models::BenefitLicenseKeysProperties>,
}

impl BenefitLicenseKeys {
    pub fn new(
        id: String,
        created_at: String,
        ...
        properties: models::BenefitLicenseKeysProperties,
    ) -> BenefitLicenseKeys {
        BenefitLicenseKeys {
            id,
            created_at,
