...
pub struct BenefitDownloadablesSubscriber {
    ...
    pub properties: Box<models::BenefitDownloadablesSubscriberProperties>,
}

impl BenefitDownloadablesSubscriber {
    pub fn new(
        id: String,
        created_at: String,
        ...
        properties: models::BenefitDownloadablesSubscriberProperties,
