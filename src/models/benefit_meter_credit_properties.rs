...
pub struct BenefitMeterCreditProperties {
    #[serde(rename = "units")]
    pub units: i32,
...
impl BenefitMeterCreditProperties {
    /// Properties for a benefit of type `meter_unit`.
    pub fn new(units: i32, rollover: bool, meter_id: String) -> BenefitMeterCreditProperties {
