...
pub struct BenefitGrantCustomWebhook {
    ...
    pub benefit: Box<models::BenefitCustom>,
    ...
    pub previous_properties: Option<serde_json::Value>,
}

impl BenefitGrantCustomWebhook {
    pub fn new(
        created_at: String,
