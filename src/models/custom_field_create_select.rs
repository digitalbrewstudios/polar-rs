...
pub struct CustomFieldCreateSelect {
    ...
    pub properties: Box<models::CustomFieldSelectProperties>,
}

impl CustomFieldCreateSelect {
    /// Schema to create a custom field of type select.
    pub fn new(
        r#type: Type,
        slug: String,
        name: String,
        properties: models::CustomFieldSelectProperties,
