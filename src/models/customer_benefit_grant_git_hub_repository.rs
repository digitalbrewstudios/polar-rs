...
pub struct CustomerBenefitGrantGitHubRepository {
    ...
    pub benefit: Box<models::BenefitGitHubRepositorySubscriber>,
    #[serde(rename = "properties")]
    pub properties: Box<models::BenefitGrantGitHubRepositoryProperties>,
}

impl CustomerBenefitGrantGitHubRepository {
    pub fn new(
        created_at: String,
        ...
        benefit: models::BenefitGitHubRepositorySubscriber,
