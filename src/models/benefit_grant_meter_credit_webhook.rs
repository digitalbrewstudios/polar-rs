...
pub struct BenefitGrantMeterCreditWebhook {
    ...
    pub previous_properties: Option<Option<Box<models::BenefitGrantMeterCreditProperties>>>,
}

impl BenefitGrantMeterCreditWebhook {
    pub fn new(
        created_at: String,
