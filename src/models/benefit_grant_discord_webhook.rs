...
pub struct BenefitGrantDiscordWebhook {
    ...
    pub benefit: Box<models::BenefitDiscord>,
    ...
    pub previous_properties: Option<Option<Box<models::BenefitGrantDiscordProperties>>>,
}

impl BenefitGrantDiscordWebhook {
    pub fn new(
        created_at: String,
