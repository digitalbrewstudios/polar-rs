...
pub struct BenefitMeterCreditUpdate {
    ...
    pub properties: Option<Option<Box<models::BenefitMeterCreditCreateProperties>>>,
}

impl BenefitMeterCreditUpdate {
    pub fn new(r#type: Type) -> BenefitMeterCreditUpdate {
