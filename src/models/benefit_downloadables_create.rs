...
pub struct BenefitDownloadablesCreate {
    ...
    pub properties: Box<models::BenefitDownloadablesCreateProperties>,
}

impl BenefitDownloadablesCreate {
    pub fn new(
        r#type: Type,
        description: String,
        properties: models::BenefitDownloadablesCreateProperties,
