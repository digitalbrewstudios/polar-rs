...
pub struct SubscriptionProductUpdatedEvent {
    ...
    pub metadata: Box<models::SubscriptionProductUpdatedMetadata>,
}

impl SubscriptionProductUpdatedEvent {
    ...
    pub fn new(
        ...
        source: Source,
        name: Name,
        metadata: models::SubscriptionProductUpdatedMetadata,
...
impl Default for Name {
    fn default() -> Name {
        Self::SubscriptionProductUpdated
    }
}
