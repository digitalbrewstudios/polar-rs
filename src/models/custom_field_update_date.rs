...
pub struct CustomFieldUpdateDate {
    ...
    pub properties: Option<Option<Box<models::CustomFieldDateProperties>>>,
}

impl CustomFieldUpdateDate {
    /// Schema to update a custom field of type date.
    pub fn new(r#type: Type) -> CustomFieldUpdateDate {
